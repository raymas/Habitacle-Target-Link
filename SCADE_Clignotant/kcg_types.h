...
/* FONCTION_HABITACLE::SIGNAL_GENERATION/SM1: */
typedef enum kcg_tag__3_SSM_TR_SM1 {
  _4_SSM_TR_no_trans_SM1,
  SSM_TR_CounterInitialisation_Clignotement_1_CounterInitialisation_SM1,
  SSM_TR_Clignotement_CounterInitialisation_1_Clignotement_SM1
} _3_SSM_TR_SM1;
/* FONCTION_HABITACLE::SIGNAL_GENERATION/SM1: */
typedef enum kcg_tag__2_SSM_ST_SM1 {
  SSM_st_CounterInitialisation_SM1,
  SSM_st_Clignotement_SM1
} _2_SSM_ST_SM1;
/* FONCTION_HABITACLE::SIGNAL_GENERATION/SM1:Clignotement:SM2: */
typedef enum kcg_tag_SSM_TR_SM2_Clignotement_SM1 {
  SSM_TR_no_trans_SM2_Clignotement_SM1,
  SSM_TR_Allumer_Reset_1_Allumer_SM2_Clignotement_SM1,
  SSM_TR_Eteindre_Reset_1_Eteindre_SM2_Clignotement_SM1,
  SSM_TR_Reset_Eteindre_1_Reset_SM2_Clignotement_SM1,
  SSM_TR_Reset_Reset_2_Reset_SM2_Clignotement_SM1,
  SSM_TR_Reset_Allumer_3_Reset_SM2_Clignotement_SM1
} SSM_TR_SM2_Clignotement_SM1;
/* FONCTION_HABITACLE::SIGNAL_GENERATION/SM1:Clignotement:SM2: */
typedef enum kcg_tag_SSM_ST_SM2_Clignotement_SM1 {
  SSM_st_Allumer_SM2_Clignotement_SM1,
  SSM_st_Eteindre_SM2_Clignotement_SM1,
  SSM_st_Reset_SM2_Clignotement_SM1
} SSM_ST_SM2_Clignotement_SM1;
/* FONCTION_HABITACLE::TRAITEMENT_CLIGNOTANT/SM1: */
typedef enum kcg_tag_SSM_TR_SM1 {
  SSM_TR_no_trans_SM1,
  SSM_TR_Initialisation_State4_1_Initialisation_SM1,
  SSM_TR_Counter_TouchAction_1_Counter_SM1,
  SSM_TR_Counter_Initialisation_2_Counter_SM1,
  SSM_TR_Counter_Counter_3_Counter_SM1,
  SSM_TR_TouchAction_Initialisation_1_TouchAction_SM1,
  SSM_TR_TouchAction_TouchAction_2_TouchAction_SM1,
  SSM_TR_State4_Counter_1_State4_SM1
} SSM_TR_SM1;
/* FONCTION_HABITACLE::TRAITEMENT_CLIGNOTANT/SM1: */
typedef enum kcg_tag_SSM_ST_SM1 {
  SSM_st_Initialisation_SM1,
  SSM_st_Counter_SM1,
  SSM_st_TouchAction_SM1,
  SSM_st_State4_SM1
} SSM_ST_SM1;
#endif /* _KCG_TYPES_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6 (build i19) ***********
